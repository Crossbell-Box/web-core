...
import type GnosisSafeProxyFactoryEthersContract from '@crossbell-box/safe-ethers-lib/dist/src/contracts/GnosisSafeProxyFactory/GnosisSafeProxyFactoryEthersContract'
